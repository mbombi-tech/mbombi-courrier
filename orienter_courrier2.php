...
=========================== */
if ($reste === 0) {
    $nouveau_statut = 'Orienté';
} else {
    $nouveau_statut = 'Orienté_ partiellement';
}
...
/* ===========================
   5. Redirection
   =========================== */
header("Location: suivre_courrier.php?tracking_code=" . urlencode($_GET['tracking_code'] ?? '') . "&validation=success");
exit;